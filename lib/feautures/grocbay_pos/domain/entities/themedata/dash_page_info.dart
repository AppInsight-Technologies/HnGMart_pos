...
import 'package:grocbay_pos/feautures/grocbay_pos/presentation/view/screen/vendor/dashboard_menu.dart';
...
class DashBoardPageInfo{
  ...
  List<DashBoardPageModle>get  pagedatabpos => [
    ...
    DashBoardPageModle(title: "",vstatus: false,widget:  UpdateOrderScreen(value!),pageKey: S.current.update_order),
    DashBoardPageModle(title: "",vstatus: false,widget:  UpdateOrderPosScreen(value!),pageKey: S.current.update_order_pos),
  ];
  ...
  //  DashBoardPageModle(title: S.current.DASHBOARD, icon: Image.asset("assets/icons/home.png",width: 20,height: 20,),vstatus: false,widget: const Home(),pageKey: S.current.DASHBOARD.toLowerCase()),
    ...
    DashBoardPageModle(title: S.current.SETTINGS,icon: Image.asset("assets/icons/setting.png",width: 20,height: 20,),vstatus: false,widget:  Orders(value!),pageKey: S.current.SETTINGS.toLowerCase()),
    DashBoardPageModle(title: "",vstatus: false,widget:  CreateOrderScreen(),pageKey: "create"),
    DashBoardPageModle(title: "",vstatus: true,widget:  UpdateOrderScreen(value!),pageKey: S.current.update_order),
    DashBoardPageModle(title: "",vstatus: true,widget:  UpdateOrderPosScreen(value!),pageKey: S.current.update_order_pos),
