...
import 'package:grocbay_pos/core/util/print/prin_usb.dart';
import 'package:grocbay_pos/core/util/print/universalprint.dart';
import 'package:grocbay_pos/feautures/grocbay_pos/domain/entities/check_loyalty_model.dart';
import 'package:grocbay_pos/feautures/grocbay_pos/presentation/view/widgte/apply_promocode_text.dart';
                                    ...
                                    child: Row(
                                      // mainAxisSize: MainAxisSize.min,
                                        ...
                                        children:[
                                          ...
                                          Text(IConstants.currencyFormat+"${cal.calculateTotalMRP(widget.list_cart_items) }",style: const TextStyle(color: Colors.black,fontSize:14,fontWeight: FontWeight.bold)),
                                        ]),
                                  ),
                                  // Padding(
                                  //   padding: const EdgeInsets.all(8.0),
...
// if()
                                          Text(IConstants.currencyFormat+"${state is LoyaltySucsess<String>?state.walletused:0 }",style: const TextStyle(color: Colors.black,fontSize:14,fontWeight: FontWeight.bold)),
                                        ]),
                                  ),
...
// if()
                                          Text(IConstants.currencyFormat+"${state is LoyaltySucsess<String>?state.promoamount:0 }",style: const TextStyle(color: Colors.black,fontSize:14,fontWeight: FontWeight.bold)),
                                        ]),
                                  ):SizedBox.shrink(),
                                    ...
                                    child: Row(
                                      // mainAxisSize: MainAxisSize.min,
                                        ...
                                        children:[
                                          ...
                                          Text(IConstants.currencyFormat+"${totalamount}",style: const TextStyle(color: Colors.blue,fontSize:16,fontWeight: FontWeight.bold)),
                                        ]),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Row(
                                      //mainAxisSize: MainAxisSize.min,
                                        ...
                                        children:[
                                          const Text("Your Savings",style: TextStyle(color: Colors.green,fontWeight: FontWeight.normal),),
                                          Text(IConstants.currencyFormat+"${ cal.calculateTotalDiscount(widget.list_cart_items,widget.user.data?.first.membership=="1") }",style: const TextStyle(color: Colors.black,fontSize:12,fontWeight: FontWeight.bold)),
                                        ]),
                                  ),
                                ],
                              ):const SizedBox.shrink(),
                      ...
                      // NavigatorTab(PageController(initialPage: 0),style:BoxStyle(
                      //   borderenabel:true,
                      //   width: MediaQuery.of(context).size.width,
                      //   height: 90,
                      // ),align:Axis.horizontal,islist: true,tabs: [
                                    ...
                                    //  print("sucsess: ${state.data.id}");
                                      ...
                                      if(_switchValue) {
                                       ...
                                       usbprinter.print(state.data,widget.list_cart_items,widget.user,waletamt,
                                                    state1.shopdata.restaurantName,
                                                    state1.shopdata.restaurantAddress,
                                                  state1.shopdata.primaryEmail,
                                                  state1.shopdata.primaryMobile,
                                                );
                                      }
                                     // print("wb : "+waletamt);
                                    }else if(state is CheckOutError){
