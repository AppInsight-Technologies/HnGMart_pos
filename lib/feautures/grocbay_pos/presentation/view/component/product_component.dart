...
import 'package:grocbay_pos/core/util/presentation/controller/global_focus.dart';
import 'package:grocbay_pos/core/util/presentation/controller/onpress_controller.dart';
import 'package:grocbay_pos/feautures/grocbay_pos/domain/entities/fetch_category_product.dart';
import 'package:grocbay_pos/feautures/grocbay_pos/presentation/bloc/homepage/category/category_bloc.dart';
import 'package:grocbay_pos/feautures/grocbay_pos/presentation/bloc/homepage/product/product_bloc.dart';
import 'package:grocbay_pos/feautures/grocbay_pos/presentation/bloc/homepage/subcategory/subCategory_bloc.dart';
import 'package:grocbay_pos/feautures/grocbay_pos/presentation/bloc/search/search_bloc.dart';
import 'package:grocbay_pos/feautures/grocbay_pos/presentation/view/widgte/dailog/dropdown.dart';
...
class _ProductState extends State<Product> with Navigations{
  ...
  Widget build(BuildContext context) {
    ...
    //  debugPrint("inside product focus");
    ...
    return Scaffold(
      ...
      },errorText: "No Product found..",empty: const Text("No Matches found....",style: TextStyle(
          color: Colors.black
      )),
