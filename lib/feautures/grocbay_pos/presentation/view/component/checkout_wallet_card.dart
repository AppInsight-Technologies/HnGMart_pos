            ...
            children: [
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        widget.w_type=="wallet"?Text(IConstants.AppName+" Wallet",style: TextStyle(color: Colors.black,fontSize:10,fontWeight: FontWeight.bold)):Text("Loyalty",style: TextStyle(color: Colors.black,fontSize:10,fontWeight: FontWeight.bold)),
                        widget.w_type=="wallet"?Text("Wallet Balence "+IConstants.currencyFormat+widget.Balance.toString(),style: TextStyle(color: Colors.grey,fontSize:8,fontWeight: FontWeight.bold)):Text(''),
                      ],
                    ),
                  ),
                ],
              ...
              Column(
                children: [
                  Row(
                    children: [
                      Text(IConstants.currencyFormat +widget.Balance.toString(),style: TextStyle(color: Colors.green,fontSize:12,fontWeight: FontWeight.bold)),
