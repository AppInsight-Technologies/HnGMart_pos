      ...
      child: Column(
        ...
        children: [
          const Padding(
            ...
            child: const Text("Profile",style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.bold),),
          ),
          const Text("Create Personal information",style: TextStyle(color: Colors.grey,fontSize: 12),),
         /* SizedBox(height: 5,),
          Row(
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text("Mobile Number*",style: TextStyle(color: Colors.black26,fontSize: 12),),
          ...
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text("Email(optional)",style: TextStyle(color: Colors.black26,fontSize: 12),),
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text("Name(optional)",style: TextStyle(color: Colors.black26,fontSize: 12),),
                    ...
                    child: FlatButton(
                      ...
                      onPressed: (){
                        ...
                        if(firstname == "" || firstname == null){
                          ...
                          {
                            Alert().showallert(context,messege: 'Please enter the mandatory fields');
                          }else if(!_numeric.hasMatch(mobilenumcontroller.text) || mobilenumcontroller.text.length != 10){

                            Alert().showallert(context,messege: 'Please enter valid mobile number');
                          }
                          else {
                        ...
                        child: BlocConsumer<RegisterBloc, RegisterState>(
                          listener: (context, state) {
                            ...
                            if (state is RegisterSucsess<CustomerRegister>) {
                              ...
                              VxToast.show(context, msg: "Order Created");
