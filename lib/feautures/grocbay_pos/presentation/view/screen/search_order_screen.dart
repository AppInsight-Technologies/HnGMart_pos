          ...
          title: Row(
            ...
            children: [
             /*IconButton(
              ...
              SizedBox(width: 10,),
              Text("Search Orders",   style: TextStyle(
                  color: Colors.black,
                  fontSize: 24,
  ...
  _searchContainermobile() {
    return
      Container(
          ...
          width: (LayoutView(context).isWeb || LayoutView(context).isTab)? MediaQuery.of(context).size.width/1.2:MediaQuery.of(context).size.width - 25,
          height: 50.0,
            ...
            Container(
              ...
              child: DecoratedBox(
                  ...
                  child: Row(crossAxisAlignment: CrossAxisAlignment.center,
                    ...
                    Container(
                        width: (LayoutView(context).isWeb || LayoutView(context).isTab)?(MediaQuery.of(context).size.width/1.2 )-57:(MediaQuery.of(context).size.width * 80 / 100) -10,
                        child: TextField(
                            autofocus: true,
                            maxLines: 1,
                ...
                child: Card(
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    ...
                    children: [
                            ...
                            child: Padding(
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.center,children: [
                                Padding(
                                  ...
                                  child: Text("Order #${data[i].oId}",style: const TextStyle(fontFamily: 'Segoe',fontSize: 14,fontWeight: FontWeight.w600)),
                                ),
                                Padding(
                                  padding: const EdgeInsets.all(8.0),
                      ...
                      ( LayoutView(context).isWeb || LayoutView(context).isTab) ?SizedBox(width: 150,):SizedBox.shrink(),
