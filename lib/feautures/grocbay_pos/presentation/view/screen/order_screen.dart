        ...
        child: BlocBuilder<GetAllCountBloc, GetAllCountState>(
            builder: (context, state) {
             /* if(state is GetAllCountLoading){
              ...
              TabData(ic_name: S
                  .of(context)
                  .Received, icon_id: "1",count: state.data.first.pendingorderscount!),
              TabData(ic_name: S
                  .of(context)
                  .Picker, icon_id: "2",count: state.data.first.processingorderscount!),
              TabData(ic_name: S
                  .of(context)
                  .Ready, icon_id: "3",count: state.data.first.readynorderscount!),
              TabData(ic_name: S
                  .of(context)
                  .Assigned_Delivery, icon_id: "4",count: state.data.first.dispatchedorderscount!),
              TabData(ic_name: S
                  .of(context)
                  .Out_for_Delivery, icon_id: "5",count: state.data.first.onwayorderscount!),
              TabData(ic_name: S
                  .of(context)
                  .delivered, icon_id: "6",count: state.data.first.deliveredorderscount!),
              // TabData(ic_name: S
              //     .of(context)
              //     .Completed, icon_id: "7",),
              // TabData(ic_name: S
