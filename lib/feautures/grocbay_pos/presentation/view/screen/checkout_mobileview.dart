...
import 'package:grocbay_pos/core/util/calculations/cartcalculations.dart';
import 'package:grocbay_pos/feautures/grocbay_pos/presentation/bloc/customers/userprofile_bloc.dart';
import 'package:grocbay_pos/feautures/grocbay_pos/presentation/view/widgte/create_profilepopup.dart';
import 'package:grocbay_pos/feautures/grocbay_pos/presentation/view/widgte/custom_stepper.dart';
import 'package:grocbay_pos/feautures/grocbay_pos/presentation/view/widgte/dailog/alert%20_dailog.dart';
import 'package:grocbay_pos/feautures/grocbay_pos/presentation/view/component/checkoutpopup.dart';
...
class _CheckoutMobileViewState extends State<CheckoutMobileView>  {
  ...
  Widget build(BuildContext context) {
    ...
    pageViewController.addListener(() {
      print("xxv");
      checkoutValueController.value.value.paymentType = pageViewController.page==0?S.of(context).cod: pageViewController.page==1?S.of(context).sod:S.of(context).online;
    });
                    ...
                    children: [
                      Expanded(
                        child: BlocProvider<SearchBloc>(
                          ...
                          },errorText: "No customer found",focus: FocusN.f_usersearch,
                              onSubmit: (e) {
                                print("ontapped ");
