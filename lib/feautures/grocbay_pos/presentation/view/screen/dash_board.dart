 ...
 bool search_status = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                      ...
                      builder: (context, state) {
                        return GestureDetector(
                            onTap:(){
                              ...
                              sl<SharedPreferences>().remove("titleview");
      ...
      floatingActionButton: (!LayoutView(context).isMobile || (sl<SharedPreferences>().containsKey("titleview") && sl<SharedPreferences>().getString("titleview") == "viewOrder"))?SizedBox.shrink():
      Container(
