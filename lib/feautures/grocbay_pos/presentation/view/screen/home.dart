                          ...
                          Container(
                            ...
                            child: Card(elevation: 2,child:  Center(
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: [
                                  Text("Home Delivery",style: TextStyle(fontSize: 12, color: Colors.black,fontWeight: FontWeight.bold)),
                                  SizedBox(height: 10,),
                          ...
                          Container(
                            ...
                            Center(
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: [
                                  Text("Express Delivery",style: TextStyle(fontSize: 12, color: Colors.black,fontWeight: FontWeight.bold)),
                                   SizedBox(height: 10,),
                          ...
                          //   height: 120,
                            ...
                            Center(
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: [
                                  Text("Pick up from Store",style: TextStyle(fontSize: 11.5, color: Colors.black,fontWeight: FontWeight.bold)),
                                  SizedBox(height: 10,),
