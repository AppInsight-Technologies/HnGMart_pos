                                      ...
                                      Column(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              padding: const EdgeInsets.only(
                                                  top: 8.0, bottom: 8.0),
                                              child: Text(state1.data.first.itemsCount.toString() + S.of(context).Item +". "+IConstants.currencyFormat+ state1.data.first.orderAmount!,
                                                style: TextStyle(
                                                    color: Colors.grey,
                                                    fontSize: 9),),
                                            )
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                Text(IConstants.currencyFormat+' ${state1.data.first
