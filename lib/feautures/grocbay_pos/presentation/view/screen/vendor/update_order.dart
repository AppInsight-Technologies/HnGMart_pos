...
import 'package:grocbay_pos/feautures/grocbay_pos/presentation/bloc/picker_list/picker_list_bloc.dart';
...
class _UpdateOrderScreenState extends State<UpdateOrderScreen> {
  ...
  void initState() {
    ...
    sl<SharedPreferences>().setString("titleview", "viewOrder");
                                              ...
                                              child: FlatButton(
                                                onPressed: () {
                                                  ...
                                                  if(double.parse(e.uweight!)>double.parse(e.weight!) && e.itemType == "1"){
                                                    ...
                                                    Alert().showallert(context,messege: "Please Enter Issue");
                                                  }else{
                                                  //  Navigator.pop(context);
                                                    List<ItemsList> items = [];
                                                    items.add(ItemsList(id:e.id ,loyalty:e.loyalty ,oqty:e.itemType=="1"?"0":e.quantity ,qty:e.itemType=="1"?"0":e.uquantity ,reason:e.selectedreason,price: e.subTotal,weight: e.uweight,cweight: e.weight,type: e.itemType ));
                            ...
                            children: [
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    SizedBox(height: 10,),
                                    Text("Select Delivery Partner",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                                    SizedBox(height: 10,),
                                    SizedBox(
                                      ...
                                      onTap: (){
                                        ...
                                        BlocProvider.of<UpdateOrderStatusBloc>(context).add(
                                            AssainDelevery(sl<SharedPreferences>().getString(Prefrence.BRANCH)??'',
                                                orderId,S.of(context).DISPATCHED.toLowerCase(),
        ...
        if(barcodeScanRes == "-1"){
          ...
          for (int i = 0; i < data.items!.length; i++) {
            ...
            if (data.items![i].barcode == barcodeScanRes) {
              ...
              Alert().showallert(
                  context, messege: "Barcode doesn't match", onpress: () {
            ...
            return
              WillPopScope(
                onWillPop: (){
                  ...
                  sl<SharedPreferences>().setString("titleview","");
                    ...
                    bottomNavigationBar:LayoutView(context).isMobile? SizedBox.shrink():Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          (state1.data.first.orderStatus == S.of(context).COMPLETED || state1.data.first.orderStatus == S.of(context).CANCELLED)?SizedBox(width: 200,):
                                          ...
                                          if(state1.data.first.items!.length == preparedItem.length){
                                            ...
                                            BlocProvider.of<UpdateOrderStatusBloc>(
                                                ...
                                                sl<SharedPreferences>().getString(
                                                    Prefrence.BRANCH) ?? '',
                                                orderId, S.of(context).READY.toLowerCase(), "", ""));
                                            /*Alert().showSuccess(context,
                                    ...
                                    child: Container(
                                      ...
                                      child: MaterialButton(onPressed:  (){
                                        if(state1.data.first.orderStatus == S.of(context).READY){
                                         ...
                                         : BlocProvider.of<UpdateOrderStatusBloc>(context).add(AssainDelevery(sl<SharedPreferences>().getString(Prefrence.BRANCH)??'',orderId,S.of(context).DISPATCHED.toLowerCase(),deliveryValueController.value.value));
                                          ...
                                          BlocProvider.of<UpdateOrderStatusBloc>(
                                              ...
                                              sl<SharedPreferences>().getString(
                                                  Prefrence.BRANCH) ?? '',
                                              orderId, S.of(context).delivered, "", ""));
                                        }
                                          ...
                                          BlocProvider.of<UpdateOrderStatusBloc>(
                                              ...
                                              sl<SharedPreferences>().getString(
                                                  Prefrence.BRANCH) ?? '',
                                              orderId, S.of(context).COMPLETED.toLowerCase(), "", ""));
                                        }else{
                          ...
                          if(stateres is MyShopSucsess) {
                            return Row(
                              ...
                              children: [
                                ...
                                (state1.data.first.orderStatus == S
                                    .of(context)
                                    .COMPLETED ||state1.data.first.orderStatus == "ONWAY"||
                                    state1.data.first.orderStatus == S
                                    .of(context)
                                    .CANCELLED ||
                                    state1.data.first.orderStatus == S
                                    .of(context)
                                    .READY ||  state1.data.first.orderStatus == S
                                    .of(context)
                                    .DISPATCHED || state1.data.first.orderStatus == S
                                    .of(context)
                                    .delivered.toUpperCase() ||  state1.data.first.orderStatus == "REACHED") ?
                                SizedBox.shrink() :
                                (state1.data.first.orderStatus == S
                                    .of(context)
                                    .RECEIVED) ?
                                          ...
                                          child: MaterialButton(onPressed: () {
                                            if (state1.data.first.orderStatus == S
                                              ...
                                              Alert().showallert(context,
                                                  ...
                                                  .add(AssainDelevery(
                                                  sl<SharedPreferences>().getString(
                                                      Prefrence.BRANCH) ?? '', orderId, S
                                                  .of(context)
                                                  .DISPATCHED
                                                  .toLowerCase(),
                                                  deliveryValueController.value.value));
                                            } else if (state1.data.first.orderStatus == S
                                                .of(context)
                                                .DISPATCHED) {
                                              BlocProvider.of<UpdateOrderStatusBloc>(
                                                  context).add(OrderReady(
                                            ...
                                            color: (state1.data.first.orderStatus == S
                                                .of(context)
                                                .READY || state1.data.first.orderStatus == S
                                                .of(context)
                                                .DISPATCHED || state1.data.first.orderStatus == S
                                                .of(context)
                                                .delivered
                                                .toUpperCase()) ? Colors.green : Colors.grey,
                                            child: Text((state1.data.first.orderStatus == S
                                                .of(context)
                                                .READY) ? S
                                                .of(context)
                                                ...
                                                .of(context)
                                                .delivered
                                                .toUpperCase() : (state1.data.first.orderStatus == S
                                                .of(context)
                                                .delivered
                                                .toUpperCase()) ? S
                                                .of(context)
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Container(
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Text((state1.data.first.orderStatus == S.of(context).RECEIVED)? S.of(context).preparing:state1.data.first.orderStatus!,
                                                              style: TextStyle(
                                                                  color: Colors.white,
                                                                  fontSize: 8),),
                                                          )
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            /*(Vx.isWeb)?*/
                                            (state1.data.first.orderStatus! == S.of(context).COMPLETED ||
                                                state1.data.first.orderStatus! == S.of(context).CANCELLED ||
                                                state1.data.first.orderStatus! == S.of(context).READY ||
                                                state1.data.first.orderStatus! == S.of(context).DISPATCHED ||
                                                state1.data.first.orderStatus! == S.of(context).PICK ||
                                                state1.data.first.orderStatus! == S.of(context).delivered.toUpperCase()||
                                                state1.data.first.orderStatus! == "ONWAY" ||
                                                state1.data.first.orderStatus! == "REACHED" )?SizedBox(width: 30,) :
                                            // BarCodeListner(
                                            //    usekey: true,
                                            //   listen: (code ) {
                                  ...
                                  child: Container(
                                      ...
                                      //  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    (state1.data.first.orderStatus! == S.of(context).COMPLETED ||
                                                        ...
                                                        state1.data.first.orderStatus! == S.of(context).DISPATCHED ||
                                                        state1.data.first.orderStatus! == S.of(context).PICK ||
                                                        state1.data.first.orderStatus! == S.of(context).onway.toUpperCase() ||
                                                        state1.data.first.orderStatus! == S.of(context).delivered.toUpperCase()||
                                                        state1.data.first.orderStatus! == "REACHED" )?SizedBox(width: 30,) :
                                                    GestureDetector(
                                                      onTap: () {
                                        ...
                                        children: [
                                           ...
                                           // SizedBox(width: 10,),
                                            Column(
                                                ...
                                                children: [
                                                  ...
                                                  SizedBox(height: 3,),
                                                  Text(e.itemType == "1" ?"Qty: "+e.weight! : "Qty: "+e.quantity!,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black26,fontSize: 9),)
                                                ]),
                                            Container(
                                                width: MediaQuery.of(context)
                                                    .size
                                          ...
                                          (state1.data.first.orderStatus! == S.of(context).COMPLETED || state1.data.first.orderStatus! == S.of(context).CANCELLED || state1.data.first.orderStatus! == S.of(context).READY || state1.data.first.orderStatus! == S.of(context).DISPATCHED || state1.data.first.orderStatus! == S.of(context).PICK )?SizedBox(width: 30,) :
                                          GestureDetector(
                                              onTap: () {
                                                showmeditpopup(e);
